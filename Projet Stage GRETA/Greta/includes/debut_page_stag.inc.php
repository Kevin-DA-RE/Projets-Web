...
<body>
    ...
    <div class="page-header text-warning">
        ...
        <nav class="navbar navbar-expand-sm bg-success justify-content-center">
            <ul class="navbar-nav">
                <li class="nav-item"><button type="button" class="btn btn-success"><a href="../view/pageMaintenanceStag.php" role='button' class="textNav text-light">Messagerie</a></button></li>
                <li class="nav-item"><button type="button" class="btn btn-success"><a href="../view/pageMaintenanceStag.php" role='button' class="textNav text-light">Drive</a></button></li>
                <li class="nav-item"><button type="button" class="btn btn-success"><a href="../view/pageMaintenanceStag.php" role='button' class="textNav text-light">Visio</a></button></li>
            </ul>
        </nav>
    </div>
