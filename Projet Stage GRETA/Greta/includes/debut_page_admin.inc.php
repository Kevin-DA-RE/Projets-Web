...
<body>
    ...
    <div class="container-fluid header">
        ...
        <nav class="navbar navbar-expand-sm bg-success justify-content-center">
            <ul class="navbar-nav">
                <li class="nav-item"><button type="button" class="btn btn-success"><a href="atelierCreat.php" role='button' class="textNav text-light">Création</a></button></li>
                <li class="nav-item"><button type="button" class="btn btn-success"><a href="user.php" role='button' class="textNav text-light">Gestion</a></button></li>
                <li class="nav-item"><button type="button" class="btn btn-success"><a href="listing.php" role='button' class="textNav text-light">Listing</a></button></li>
            </ul>
        </nav>
    </div>
