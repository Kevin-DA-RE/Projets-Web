...
<body id="body">
    <section class="messInterm">
        <article>
            <p>Une erreur lors de l'enregistrement de l'activite type a provoquer l'echec de son enregristrement <br><br>
                Souhaitez-vous revenir au formulaire ou a l'atelier création ?
            </p>
        </article>
            <nav class="btnMess">
                <button class="btn btn-warning"><a href="atelierCreat.php" class="text-light"><h3>Atelier de création</h3></a></button> 
                <button class="btn btn-success"><a href="form_ajouter_activite_type.php" class="text-light"><h3>Créer Activité Type</h3></a></button> 
            </nav>
    </section>
</body>
