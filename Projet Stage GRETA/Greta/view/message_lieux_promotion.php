...
<body id="body">
    <section class="messInterm">
        <article>
            <p>Félicitations, un nouveau site de formation vient d’être ajouté ! <br><br>
                Souhaitez-vous visionner la liste des lieux, revenir à l'atelier de création ou en créer un autre ?
            </p>
        </article>
            <nav class="btnMess">
                <button class="btn btn-info "><a href="sites_formations.php" class="text-light"><h3>Liste Sites</h3></a></button> 
                <button class="btn btn-warning"><a href="atelierCreat.php" class="text-light"><h3>Atelier de création</h3></a></button> 
                <button class="btn btn-success"><a href="form_ajouter_site.php" class="text-light"><h3>Créer Site</h3></a></button> 
            </nav>
    </section>
</body>
