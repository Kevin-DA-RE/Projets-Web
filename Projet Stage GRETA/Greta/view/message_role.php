...
<body id="body">
    <section class="messInterm">
        <article>
            <p>Félicitations, un nouveau rôle vient d’être ajouté ! <br><br>
                Souhaitez-vous visionner la liste des rôles, revenir à l'atelier de création ou en créer un autre ?
            </p>
        </article>
            <nav class="btnMess">
                <button class="btn btn-info "><a href="listRoles.php" class="text-light"><h3>Liste Rôle</h3></a></button> 
                <button class="btn btn-warning"><a href="atelierCreat.php" class="text-light"><h3>Atelier de création</h3></a></button> 
                <button class="btn btn-success"><a href="addRole.html.php" class="text-light"><h3>Créer rôle</h3></a></button> 
            </nav>
    </section>
</body>
